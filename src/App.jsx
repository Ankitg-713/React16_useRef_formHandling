  ...
  return (
    <div className='w-full h-screen flex justify-center items-center'>
      <form className='w-60 h-52 items-center p-4 border border-zinc-400' action="" onSubmit={handleSubmit}>
        <input className='m-2 border border-zinc-400' type="text" placeholder='Name' ref={nameRef} />
        <input className='m-2 border border-zinc-400' type="text" placeholder='Age' ref={ageRef} />
        <div>
